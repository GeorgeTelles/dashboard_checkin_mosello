...
const AudienceEvolutionChart = () => {
    return (
        <div className="bg-white p-6 rounded-xl border border-slate-200 h-96 dark:bg-slate-800 dark:border-slate-700">
            <h3 className="font-bold text-lg text-gray-800 dark:text-slate-100">Evolução de Audiências</h3>
            <p className="text-sm text-gray-500 dark:text-slate-400">Total de audiências nos últimos 6 meses</p>
